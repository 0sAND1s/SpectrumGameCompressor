...
..\..\tools\hcdisk2 format %output% -t 2 -y : open %output% : basimp %name%ldr.bas %name%HC : put %name%scr -t b -s 16384 : put hcdskldr -t b -s 32768 : put %name%lvl0 -t b -s 31790 : put %name%lvl1 -t b -s 25600 : put %name%lvl2 -t b -s 25600 : put %name%lvl3 -t b -s 25600 : put %name%lvl4 -t b -s 35390 : put %name%lvl5 -t b -s 35390 : put %name%lvl6 -t b -s 40000 : dir : exit

@REM Cleanup
del %name%scr %name%lvl0 %name%lvl1 %name%lvl2 %name%lvl3 %name%lvl4 %name%lvl5 %name%lvl6 %name%ldr hcdskldr lvlldr.bin