...
..\..\tools\hcdisk2 format %output% -t 2 -y : open %output% : basimp %name%ldr.bas %name% : put %name%scr -t b -s 16384 : put %levelldr% -t b -s 32768 : put %name%main1 -n %name%main -t b -s 40000 : put %name%lvl1 -t b -s 25485 : put %name%lvl2 -t b -s 25485 : put %name%lvl3 -t b -s 25485 : dir : exit

@REM Cleanup
del %name%scr %name%main %name%lvl1 %name%lvl2 %name%lvl3 %name%ldr1 %name%ldr2 %levelldr% lvlldr.bin %name%main1 mover