...
..\..\tools\hcdisk2 format %output% -t 2 -y : open %output% : basimp %name%ldr.bas Robocop1HC : put %name%scr -t b -s 16384 : put %levelldr% -t b -s 32768 : put %name%main -t b -s 32767 : put %name%lvl1 -t b -s 43608 : put %name%lvl2 -t b -s 43608 : put %name%lvl3 -t b -s 43608 : put %name%lvl4 -t b -s 43608 : put %name%lvl5 -t b -s 43608 : dir : exit

@REM Cleanup
del %name%scr %name%main %name%lvl1 %name%lvl2 %name%lvl3 %name%lvl4 %name%lvl5 %name%ldrhc %levelldr% rbclvlldr1 rbclvlldr2